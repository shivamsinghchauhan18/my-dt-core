...
analyze_robot_system() {
    ...
    ssh_robot "echo '=== CATKIN WORKSPACE ===' && \
               ...
               echo -e '\n=== DT-CORE PACKAGES ===' && \
               ls -la /code/catkin_ws/src/dt-core/packages/ | head -20 && \
               echo -e '\n=== BUILD STATUS ===' && \
...
analyze_current_dtcore() {
    ...
    ssh_robot "echo '=== LINE DETECTOR FILES ===' && \
               find /code/catkin_ws/src/dt-core/packages/line_detector -name '*.py' -exec echo 'File: {}' \; -exec head -20 {} \; -exec echo '---' \; 2>/dev/null"
...
test_enhanced_deployment() {
    ...
    scp_robot "$PROJECT_ROOT/packages/line_detector/src/line_detector_node.py" "/tmp/enhanced_staging/"
