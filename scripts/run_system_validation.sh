...
VALIDATION_SCRIPT="$PROJECT_ROOT/packages/easy_regression/src/run_comprehensive_validation.py"
...
setup_environment() {
    ...
    # Set Python path
    export PYTHONPATH="$PROJECT_ROOT/packages/easy_regression/src:$PYTHONPATH"
