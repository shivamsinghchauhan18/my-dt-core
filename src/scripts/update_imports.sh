...
create_compatibility_layer() {
    ...
    mkdir -p "$PROJECT_ROOT/src/packages/duckietown_msgs/src/duckietown_msgs/msg/enhanced"
    
    cat > "$PROJECT_ROOT/src/packages/duckietown_msgs/src/duckietown_msgs/msg/enhanced/__init__.py" << 'EOF'
"""
