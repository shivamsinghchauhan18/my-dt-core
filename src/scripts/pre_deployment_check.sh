...
run_check "pinkduckie config file" "test -f \"$PROJECT_ROOT/src/robot_configs/pinkduckie.yaml\""
echo
...
# Key packages
echo "=== Key Packages ==="
run_check "duckietown_msgs package" "test -d \"$PROJECT_ROOT/src/packages/duckietown_msgs\""
run_check "line_detector package" "test -d \"$PROJECT_ROOT/src/packages/line_detector\""
run_check "lane_control package" "test -d \"$PROJECT_ROOT/src/packages/lane_control\""
run_check "vehicle_detection package" "test -d \"$PROJECT_ROOT/src/packages/vehicle_detection\""
run_check "navigation package" "test -d \"$PROJECT_ROOT/src/packages/navigation\""
run_check "fsm package" "test -d \"$PROJECT_ROOT/src/packages/fsm\""
echo

# Enhanced components
echo "=== Enhanced Components ==="
run_check "Enhanced line detector" "grep -q 'AdaptiveThresholdDetector' \"$PROJECT_ROOT/src/packages/line_detector/src/line_detector_node.py\""
run_check "Temporal filtering" "grep -q 'TemporalConsistencyFilter' \"$PROJECT_ROOT/src/packages/line_detector/src/line_detector_node.py\""
run_check_with_warning "Enhanced AprilTag detection" "test -d \"$PROJECT_ROOT/src/packages/enhanced_apriltag\""
...
if [[ $error_count -eq 0 ]]; then
    ...
    echo "  ./src/scripts/deploy_pinkduckie.sh"
    exit 0
